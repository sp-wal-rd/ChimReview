 ...
 * @version V1.2.1
 * @date    2025-07-24
 * @brief   Header file of UASI2 module.
 ******************************************************************************
 * @attention
 *
...
#define USCI2_UART_BaudRate_FsysDIV12 0X00 
///仅模式0可用，串行端口在系统时钟的1/4下运行
#define USCI2_UART_BaudRate_FsysDIV4 0X01  

/** @defgroup USCI2_Enumerations USCI2 Enumerations
 * @{
 */
 
 /** @brief USCI2_CommunicationMode_TypeDef USCI2 Communication Mode
 * @{
 */
typedef enum
{
...
/** @brief USCI2_SPI_FirstBit_TypeDef SPI FirstBit
 * @{
 */
typedef enum
{
...
/** @brief USCI2_SPI_BaudRatePrescaler_TypeDef SPI BaudRate Prescaler
 * @{
 */
typedef enum
{
...
/** @brief USCI2_SPI_Mode_TypeDef SPI Mode
 * @{
 */
typedef enum
{
...
/** @brief USCI2_SPI_ClockPolarity_TypeDef SPI Clock Polarity
 * @{
 */
typedef enum
{
...
/** @brief USCI2_SPI_ClockPhase_TypeDef SPI Mode
 * @{
 */
typedef enum
{
...
typedef enum
{
  USCI2_SPI_TXE_DISINT = (uint8_t)0x00, /*!< TXE为0时不允许发送中断 */
  USCI2_SPI_TXE_ENINT = (uint8_t)0x08   /*!< TXE为1时允许发送中断 */
} USCI2_SPI_TXE_INT_TypeDef;
/**
 * @}
 */

/** @brief USCI2_TransmissionMode_TypeDef UART Transmission Mode
 * @{
 */
typedef enum
{
...
/** @brief USCI2_TWI_MasterCommunicationRate_TypeDef TWI Communication Rate
 * @{
 */
typedef enum
{
...
/** @brief USCI2_TWIState_TypeDef TWI State
 * @{
 */
typedef enum
{
...
/** @brief USCI2_UART_Mode_TypeDef UART Mode
 * @{
 */
typedef enum
{
  ...
  USCI2_UART_Mode_11B = 0XC0  /*!< UART设置为11位模式 */
} USCI2_UART_Mode_TypeDef;
/**
 * @}
 */

/** @brief USCI2_UART_RX_TypeDef UART RX
 * @{
 */
typedef enum
{
...
/** @brief USCI2_Flag_TypeDef UART Flag
 * @{
 */
typedef enum
{
...
/** @addtogroup USCI2_Functions USCI2 Functions
 * @{
 */
/********************************* SPI **************************************************/
